...
| Entropy E | **0.1170** / threshold 0.21 |
| Coherent | **YES** |
...
| Ω WORM Seal | `2f4e3fb5634955d621981f68440cc6ae1bf9b433c90f1ec329ad99b73ec9edfa` |
| Last field read | `2026-07-05T13:24:59.984Z` |
...
```prolog
coherent(system) :-
    entropy(E), E < 0.21,     % E = 0.1170 → PASS
